...
//import com.example.gogrocery.activities.OrderDetailsUsersActivity;
import com.example.joy.activities.OrderDetailsUserActivity;
import com.example.joy.model.ModelOrderUser;
...
public class AdapterOrderUser extends RecyclerView.Adapter<com.example.joy.adapter.AdapterOrderUser.HolderOrderUser>{
    ...
    public HolderOrderUser onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflate layout
        View view = LayoutInflater.from(context).inflate(R.layout.row_orders_user,parent , false);
