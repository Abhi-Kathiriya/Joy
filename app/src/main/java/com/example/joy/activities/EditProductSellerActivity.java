...
public class EditProductSellerActivity extends AppCompatActivity {
    ...
    private EditText titleEt,descriptionEt,instructionEt,deliveryTimeEt,priceEt,discountedPriceEt,discountedNoteEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deliveryTimeEt = (EditText) findViewById(R.id.deliveryTimeEt);
    ...
    private void loadProductDetails() {
        ...
        reference.child(firebaseAuth.getUid()).child("category").child(categoryId).child("products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String productInstruction =""+dataSnapshot.child("productInstruction").getValue();
                        String deliveryTime =""+dataSnapshot.child("deliveryTime").getValue();
                        ...
                        instructionEt.setText(productInstruction);
                        discountedNoteEt.setText(discountNote);
                        priceEt.setText(originalPrice);
                        deliveryTimeEt.setText(deliveryTime);
    ...
    private String productTitle, productDescription, productInstruction, originalPrice, discountPrice, discountNote, deliveryTime;
    private boolean discountAvailable = false;
    private void inputData() {
        productTitle = titleEt.getText().toString().trim();
        productDescription = descriptionEt.getText().toString().trim();
        productInstruction = instructionEt.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(productDescription)){
            ...
            return;
        }if (TextUtils.isEmpty(productInstruction)){
