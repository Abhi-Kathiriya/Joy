...
public class AddItemActivity extends AppCompatActivity {
    ...
    private void inputData() {
        ...
        if (TextUtils.isEmpty(originalPrice)){
            ...
            Toast.makeText(this, "Delivery time is required...", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void addProduct() {
        ...
        if (image_uri==null){
            ...
            reference.child(firebaseAuth.getUid()).child("category").child(categoryId).child("products").child(timestamp).setValue(hashMap)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                ...
                                hashMap.put("productDescription", ""+productDescription);
                                hashMap.put("productInstruction", ""+productInstruction);
                                hashMap.put("productIcon", ""+downloadImageUri);//no image, empty set
                                hashMap.put("originalPrice", ""+originalPrice);
                                hashMap.put("discountPrice", ""+discountPrice);
                                hashMap.put("discountNote", ""+discountNote);
                                hashMap.put("favourite", "false");
    ...
    private void clearData(){
        ...
        productIconIv.setImageResource(R.drawable.ic_baseline_add_photo_alternate_24);
        image_uri = null;
    }
